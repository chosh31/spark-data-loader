...
object DkyBetaKafkaProblemFullTest {
  def main(args: Array[String]) {
    ...
    val path = "/home/ec2-user/parquet/totalTest/problem"
    ...
    val kafkaParams = Map[String, Object](
        ...
        "group.id" -> "kafka-problem-full-test",
        "auto.offset.reset" -> "latest",
        "enable.auto.commit" -> (false: java.lang.Boolean)
     )

    val topics = Array("log-dky-beta-full-problem")
    ...
    inputStream.foreachRDD { rdd =>
       ...
       println("in problem full looping")
       if (!rdd.isEmpty) {
           println("rdd exist!")
