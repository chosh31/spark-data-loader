...
object DkyStableKafkaProblemTest {
  def main(args: Array[String]) {
    ...
    val path = "/home/ec2-user/parquet/stableTest/problem"
    ...
    val topics = Array("log-dky-stable-problem")
    ...
    inputStream.foreachRDD { rdd =>
       ...
       println("in problem stable looping")
       if (!rdd.isEmpty) {
           println("rdd exist!")
