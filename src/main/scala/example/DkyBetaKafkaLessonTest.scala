...
object DkyBetaKafkaLessonTest {
  def main(args: Array[String]) {
    ...
    val path = "/home/ec2-user/parquet/lesson/dky"
    ...
    val kafkaParams = Map[String, Object](
        ...
        "group.id" -> "kafka-lesson-test",
        "auto.offset.reset" -> "latest",
        "enable.auto.commit" -> (false: java.lang.Boolean)
     )

    val topics = Array("log-dky-beta-lesson")
